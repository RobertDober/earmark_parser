defmodule EarmarkParser.Line do
  ...
  defmodule Heading  do
    @moduledoc false
    defstruct(annotation: nil, lnb: 0, line: "", indent: -1, level: 1, content: "inline text", inside_code: false)
  end

  defmodule BlockQuote  do
    @moduledoc false
    defstruct(annotation: nil, lnb: 0, line: "", indent: -1, content: "text", inside_code: false)
  end
  ...
  defmodule Ial  do
    @moduledoc false
    defstruct(annotation: nil, lnb: 0, line: "", indent: -1, attrs: "", inside_code: false, verbatim: "")
  end
  defmodule Text  do
    @moduledoc false
    defstruct(annotation: nil, lnb: 0, line: "", indent: -1, content: "", inside_code: false)

defmodule Acceptance.Ast.LinkImages.LinkTest do
  ...
  describe "Links" do
    ...
    test "illegal ulrs are not EarmarkParser's responsibility (was regtest #51)" do
      ...
      html =
        ~s[<p><a href="http://elixir-lang.org/docs/master/elixir/Kernel.SpecialForms.htm#<<>>/1">&lt;&lt;&gt;&gt;/1</a></p>]
    ...
    test "escapes in link's name (was regtest #51)" do
      ...
      html =
        ~s{<p><a href="http://elixir-lang.org/docs/master/elixir/Kernel.SpecialForms.htm#&expr/1">&amp;expr/1</a></p>}
